...
- TTS density parsing
- Correct density-to-block pairing after the Z-axis coordinate conversion
- `PoiGrid` terrain representation and density lookup
- Terrain diagnostics, real POI scans and density histograms
- Initial regular-cell Transvoxel terrain mesh generation
- Fixed-point terrain vertex interpolation
- Generated terrain normals
- Worker-thread terrain generation
- Terrain meshes attached to the loaded POI scene
